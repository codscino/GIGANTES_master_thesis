function [vinf1, alpha1, crank1, vinf2, alpha2, crank2, tofsc] = pseudoResTransf( type, N, M, vinf, idmoon, idcentral, remove81 )
...
S = [ type +1 N M 0 ];
[~, ~, tofsc, node, alpha1] = wrap_VILT(S, vinf, vinf, 0, pi, idmoon, idcentral);
