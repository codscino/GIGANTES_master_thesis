...
%--------------------------------------------------------------------------
pars.Moon.MoonName='Enceladus'; % for plotting purposes
...
% Printing some info
%--------------------------------------------------------------------------
disp(['The NODEIN is ',num2str(vinfin),' km/s, Pump of ', num2str(alfain*180/pi),' deg and Crank of ',num2str(kin*180/pi),' deg' ])
disp(['The NODEOUT is ',num2str(vinfin),' km/s, Pump of ', num2str(alfaou*180/pi),' deg and Crank of ',num2str(kou*180/pi),' deg' ])
disp(['Hence, a DAlpha of ',num2str((alfaou-alfain)*180/pi),' deg and DK of ',num2str((kou-kin)*180/pi),' deg' ])
