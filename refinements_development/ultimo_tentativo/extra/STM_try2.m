%%  STM with also deltaV calculation, but no optimization
clc;
clear all;
close all;
...
pars.INPUTS.perturbingBodyNaifIDs = [10];
...
[NB_in_corrected, B_achieved] = performSTMOptimizationEnhanced(pars, nodein, nodeout);
...
%% ========================================================================
%  HELPER FUNCTIONS (Include all your existing helper functions here)
%  ========================================================================
