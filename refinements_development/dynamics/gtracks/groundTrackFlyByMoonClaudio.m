...
%% OUTPUTS %%
% - yy: Matrix of size [2*npoints-1 x 6] containing the state vector
%       (position & velocity) resulting from the forward & backward propagation
%       from the flyby periapsis point. Units [km] & [km/s].
%
% - tt: Matrix of size [2*npoints-1 x 1] containing the time steps of the 
%       propagation of the flyby hyperbola.
%
% - RR: Matrix of size [2*npoints-1 x 1] containing the norm of the position 
%       vector of the flyby hyperbola. Units [km].
%
% - VV: Matrix of size [2*npoints-1 x 1] containing the norm of the velocity 
%       vector of the flyby hyperbola. Units [km/s].
%
% - lats: Matrix of size [2*npoints-1 x 1] containing the Latitude of the 
%         ground-track points. Units [rad].
%
% - longs: Matrix of size [2*npoints-1 x 1] containing the Longitude of the 
%          ground-track points. Units [rad].
%
