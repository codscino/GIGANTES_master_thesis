function [] = Plot_Flyby_GT_claudio(Flyby_Data, color)
...
if ~isempty(stop_index) && ~isequal(stop_index, 1)
    ...
    plot(rp_long, rp_lat, 'o', 'MarkerEdgeColor', 'black', 'MarkerFaceColor', 'red', 'MarkerSize', 10 );
    ...
    legend('Groundtrack', 'Flyby Entry Point', 'Flyby Periapsis', 'Flyby Exit Point');
