...
date0 = [2025, 5, 10, 21, 46, 59]; 
T0 = date2mjd2000(date0);
pars.INPUTS.epoch0 = T0;
...
for i = 1:size(Flyby, 2)
    % Plot_Flyby_GT_illumination(Flyby(i), colors(i,:), T0, 1)
    % Plot_Flyby_GT_illuminationv3(Flyby(i), colors(i,:), T0, spiceParam)
