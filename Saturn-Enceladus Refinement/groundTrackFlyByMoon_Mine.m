function [yy, tt, RR, VV, lats, longs, vvinfouBM, delta, lat, long] = ...
    groundTrackFlyByMoon_Mine(vvinfin, vvinfou, deltaMax, rr, vv, muPL, pars)
...
[tt1, yy1] = propagateKepler(rrp, vvp, linspace(0, -t_prop*60, npoints), muPL);
tt1        = flip(tt1);
yy1        = flip(yy1);
[tt2, yy2] = propagateKepler(rrp, vvp, linspace(0, t_prop*60, npoints), muPL);
yy         = [yy1; yy2];
tt         = [tt1; tt2];
