...
%% TESTCASE 3
%--------------------------------------------------------------------------
% Here I search for 10 fly-by sequence with as many as possible leading and
% trailing groundtracks. I will define a leading or trailing groundtrach a
% fly-by whose GT crosing either the leading or the trailing edge. 
