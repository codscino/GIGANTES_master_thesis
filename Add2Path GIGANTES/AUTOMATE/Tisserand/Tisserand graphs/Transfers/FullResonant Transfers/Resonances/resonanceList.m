...
elseif idcentral == 7 % --> central body : URANUS
    if idMO == 1
        % --> Miranda
        list = [[3 1]; [7 2]; [4 1]; [9 2]; [5 1]; [11 2];[6 1]; [13 2]; [7 1]; [8 1]; [9 1]];
    elseif idMO == 2
        % --> Ariel
        list = [[2 1]; [5 2]; [3 1]; [7 2]; [4 1]; [9 2]; [5 1]; [11 2]; [6 1]; [13 2]; [7 1]; [8 1]];
    elseif idMO == 3
        % --> Umbriel
        list = [[1 1]; [3 2]; [2 1]; [5 2]; [3 1]; [7 2]; [4 1]; [9 2]; [5 1]; [11 2]; [6 1]; [13 2]; [7 1]; [8 1]]; 
    elseif idMO == 4
        % --> Titania
        list = [[4 1]; [7 2]; [3 1]; [5 2]; [2 1]; [3 2]; [1 1]];
    elseif idMO == 5
        % --> Oberon
        list = [[4 1]; [7 2]; [3 1]; [5 2]; [2 1]; [3 2]; [1 1]];
    end
