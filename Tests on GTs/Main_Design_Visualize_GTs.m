...
% This script is set up to help designing sets of groundtracks with
% selected paths on ground. 
...
alfain = deg2rad(20); kin = deg2rad(270);
...
Delta_Alpha=3.27968384368076e-05;
Delta_Crank=0.00459148410603568;
...
SetofAvailableOptions=zeros(2*length(PossibleDelta_alphas),5);
...
Summary=[PossiblePeri1 PossibleDelta_alphas(j) Delta_Crank_2max(1); PossiblePeri2 PossibleDelta_alphas(j) Delta_Crank_2max(2)];
